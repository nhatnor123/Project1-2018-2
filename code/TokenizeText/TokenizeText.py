    ...
    def TokenizeText( listWordExample, start, end):
        ...
        for i in range(end, start - 1, -1):
            if i == start:
                ...
                # print(tempString)
                if tempString.lower() in TokenizeText.dictionary:
...
def Tokenize(data):
    global result
    list = TokenizeText.ListWord(data)
    result = ""
    TokenizeText.TokenizeText(list, 0, len(list) - 1)
    return result




print(Tokenize("tinh ,thông nhatnor123@gmail.com khả thi Hôm nay tôi muốn đi chơi với kfjslkjf lksjdfl ji  công ty tnhh mtv Nguyễn lưu nhật mọi người"))
