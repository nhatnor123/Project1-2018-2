...
class ClawlVNExpress(scrapy.Spider):
    ...
    def start_requests(self):
        urls = ['https://vnexpress.net/thoi-su/bo-truong-giao-thong-de-nghi-ai-mat-giay-phep-lai-xe-deu-phai-thi-lai-3890474.html']
    ...
    def parse_artilce(self, response):
        ...
        artilce['CONTENT'] = response.xpath('/html/body/section[2]/section[1]/section[1]/article').extract()[0].encode('utf-8').strip()
